...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification 
{
	...
	{
		std::string optdir = getenv("HOME") + std::string("/Library/Claw");
	...
	std::string options = getenv("HOME") + std::string("/Library/Claw/config/options.txt");
...
- (IBAction)launch:(id)sender
{
	...
	{
		td.erase(rpos);
		td += "claw.app/Contents/MacOS/claw"; */
		td += "/claw.app/Contents/MacOS/claw";
